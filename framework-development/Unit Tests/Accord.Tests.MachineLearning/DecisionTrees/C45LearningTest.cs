...
namespace Accord.Tests.MachineLearning
{
    ...
    public class C45LearningTest
    {
        ...
        //public void CreateTextClassificationTrainingData(string featureFilePath)
        //{
        ...
        //        }
        //    }
        //    var c45DecisionTree = PrepareC45Data(lstFeatures, Path.GetDirectoryName(featureFilePath) + "/TRAININGDATA");
        ...
        //    lstFeatures.ForEach(x => data.Columns.Add("FEATURE_" + ++count, typeof(bool)));
        //    //Add Class Columns
        ...
        //    foreach (var filePaths in GetTrainingFilePaths(trainingDataLocation))
        //    {
        //        count = 0;
        ...
        //                {
        //                    row["FEATURE_" + ++count] = text.Contains(feature);
        //                });
        ...
        //    DecisionVariable[] attributes = new DecisionVariable[lstFeatures.Count + 1];
        //    count = 0;
        //    foreach (var feature in lstFeatures)
        //    {
        //        attributes[count] = new DecisionVariable("FEATURE_" + ++count, codebook["FEATURE_" + count].Symbols); // 2 possible values (true, false)
        //    }
        //    //attributes[count] = new DecisionVariable("ResultClass", codebook["ResultClass"].Symbols);


        //    int classCount = codebook["ResultClass"].Symbols; // no of classes
        ...
        //    data.Columns.To<List<DataColumn>>().ForEach(x =>
        //        {
        ...
        //    //inputs = symbols.ToArray("Outlook", "Temperature", "Humidity", "Wind");
        //    c45Output.tree = tree;
        //    c45Output.inputs = symbols.ToArray(lstColumnNames.ToArray());
        ...
        //private Dictionary<string, List<string>> GetTrainingFilePaths(string directoryPath)
        //{
        ...
        //    {
        //        string cls = Path.GetDirectoryName(directory);
        //        var files = Directory.GetFiles(directory);
        //        dicFiles.Add(cls, files.To<List<string>>());
        //    }
        //    return dicFiles;
        //}
